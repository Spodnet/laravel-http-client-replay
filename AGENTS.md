...
- Keep package names, namespaces, Composer metadata, publish tags, documentation, and examples aligned with `spodnet/laravel-http-client-replay`.
...
- Follow SOLID paradigyms but keep code simple and readable, so some variation is allowed if it reduces complexity
